...
- مثال: .انشاء حساب الرافدين او ريك ثون الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "ريك ثون الاسلامي":
        bankn = "مصرف ريك ثون الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "ريك ثون الاسلامي":
